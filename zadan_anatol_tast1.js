const users = [                                 // Task 1.Написать функцию, которая найдет и выведет в консоль юзеров, зарегистрированных 09.10.2021 и 10.10.2021). Массив в task1.txt
    {
        firstName: 'John',
        lastName: 'Caper',
        phone: '7436676737634',
...
const filterUsers = users.filter(item => item.registrationDate == '09.10.2021' || item.registrationDate == '10.10.2021')  
